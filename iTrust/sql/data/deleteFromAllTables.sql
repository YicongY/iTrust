...
DELETE FROM OBOfficeVisit;
ALTER TABLE OBOfficeVisit AUTO_INCREMENT = 0;

DELETE FROM UltrasoundRecord;
ALTER TABLE UltrasoundRecord AUTO_INCREMENT = 0;

DELETE FROM initOBrecord;
ALTER TABLE initOBrecord AUTO_INCREMENT = 0;

DELETE FROM obchildbirthvisit;
ALTER TABLE obchildbirthvisit AUTO_INCREMENT = 0;

DELETE FROM pregnancyRecord;
ALTER TABLE pregnancyRecord AUTO_INCREMENT = 0;
