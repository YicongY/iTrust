...
CREATE TABLE patients(
	...
	OBEligibility boolean not null default 0,
	PRIMARY KEY (MID)
) ENGINE=MyISAM;
...
CREATE TABLE appointment (
	...
	comment				TEXT,
	isRated			  boolean default 0 NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE allergies(
	...
	FOREIGN KEY (ID) REFERENCES patients(MID)
...
CREATE TABLE OBOfficeVisit (
	visitID BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT(20) UNSIGNED NOT NULL,
	locationID VARCHAR(10),
	apptTypeID INT(10) UNSIGNED,
	currentDate Date,
	numOfWeeks VARCHAR(255),
	weight float,
	bloodPressure VARCHAR(7),
	fetalHeartRate Int,
	isMultiplePregnancy BOOLEAN,
	numOfMultiplePregnancy Int,
	isLowLyingPlacentaObserved BOOLEAN,
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID),
	FOREIGN KEY (locationID) REFERENCES hospitals(HospitalID),
	FOREIGN KEY (apptTypeID) REFERENCES appointmenttype(apptType_id)
...
CREATE TABLE initOBrecord (  MID bigint(20) UNSIGNED,
  recorddate DATE,
...
CREATE TABLE pregnancyRecord(
  pregnancy_id bigint(20) unsigned not null AUTO_INCREMENT,
  pregnancyterm int,
  deliverytype varchar(40),
  yearofconception  int not null,
  numberofhoursinlabor float,
  weightgainduringpregnancy int,
  pregnancytype int,
  patientMID BIGINT(20) UNSIGNED NOT NULL,
...
CREATE TABLE UltrasoundRecord (
 	...
 	obOfficeVisitID BIGINT(20) UNSIGNED NOT NULL,
 	patientMID BIGINT(20) UNSIGNED NOT NULL,
 	locationID VARCHAR(10) NOT NULL,
 	...
 	FOREIGN KEY (obOfficeVisitID) REFERENCES OBOfficeVisit(visitID),
 	FOREIGN KEY (patientMID) REFERENCES patients(MID)
 ) ENGINE=MyISAM;
