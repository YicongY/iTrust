...
public class TestDataGenerator {
	...
	public void report() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/report.sql");
	}
	...
	/**
	 * Generate a patient with MID 800, OBEligibility true for UC93
	 * */
	...
	public void uc94_addAppointmentType() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/addAppointmentType.sql");
	}

	public void uc95_addNewICCode() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/addNewICCode.sql");
	}
	...
	/*
	 *	test data: patient with MID 801 and appointment data
	 */
	...
	/**
	 *  test data: rating and finished appointment data for patient with MID 2
	 */
	public void uc807() throws SQLException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc807.sql");
	}


	public void uc807SetUp() throws SQLException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc807Setup.sql");
	}

	public void uc807TearDown() throws SQLException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/uc807TearDown.sql");
	}
	...
	public void standardData() throws FileNotFoundException, IOException, SQLException {
		...
		uc93();
		// NEW: Added for UC94
		uc94_addAppointmentType();
		// NEW: New IC Code Added for UC95
		uc95_addNewICCode();
		uc95();
		// NEW: Added for UC96
        uc96();
