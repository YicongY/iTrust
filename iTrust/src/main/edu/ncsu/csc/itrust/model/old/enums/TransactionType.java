...
public enum TransactionType {
	...
	VIEW_LABOR_DELIVERY_REPORT(9500, "View Labor Delivery Report", "View Labor Delivery Report", true),
	/**PATIENT_VIEW_OPHTHALMOLOGY_SURGERY**/
	EDIT_ULTRASOUND(9403, "EDIT ULTRAASOUND", "EDIT ULTRASOUND", true),
	/**PATIENT_VIEW_OPHTHALMOLOGY_SURGERY**/
	/**Create Childbirth Visit**/
	CREATE_CHILDBIRTH_VISIT(9600, "Create Childbirth Visit", "CREATE_INITIAL_OBSTETRICS_RECORD", true),
	...
	/**View childbirth visit**/
	VIEW_CHILDBIRTH_VISIT(9605, "View childbirth visit", "View childbirth visit", true),

	ADD_APPOINTMENT_RATING(9700, "Add appointment rating", "Patient rates a doctor", true),
	VIEW_APPOINTMENT_RATING(9701, "View appointment rating", "Patient views a previous rating of a doctor", true),
	VIEW_DOCTOR_OVERALL_RATING(9701, "View doctor overall rating", "Patient views overall rating of a doctor", true),
	;
	/**
