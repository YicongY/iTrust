...
<%
	...
	<div class="modal-footer">
   	<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
					...
					Map<String, Float> results = rc.getOverallRating(Long.toString(expert.getMID()));
					...
					double avgRating = (punctuality + attitude + skillfulness + knowledge + efficiency) / 5;

					int ratingSize = rc.getRatingPeopleNumber(Long.toString(expert.getMID()));
					...
					{ 
						...
						%>
							<div class="grey-border-container">
								...
								<p><b>Rating By:</b> <%= ratingSize%> patient(s)</p>
								<p><b>Avg Rating:</b> <%= ratingSize == 0 ? "N/A" : avgRating %></p>
								<a href="reviewsPage.jsp?expertID=<%=expert.getMID()%>" id="<%= i %>" ><span class="font1">View Details</span></a>
							</div>
						<% 
					}
				}
